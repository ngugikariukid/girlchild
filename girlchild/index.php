        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#tf-contact" class="page-scroll">Contact</a></li>
              <li><a href="register.php" class="page-scroll"> <strong><span class="color">Register / Login</span></strong></a></li>
                  ...
                  <div id="tf-services" class="text-center">
                      <div class="container">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-3 col-sm-6 service">
                                  <a href="logged/requesthelp.php"> <i class="fa fa-bullhorn"> </i> </a>
                              ...
                              <div class="col-md-3 col-sm-6 service">
                                  <a href="logged/donate.php"><i class="fa fa-camera"></i></a>
              ...
              echo "<div id='lightbox' class='row'>";
                  ...
                  echo "<div class='portfolio-item'>";
                      echo "<div class='hover-bg'>";
                          echo "<a href='logged/gethelp.php?email=".$row['useremail']."'> ";
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div id="testimonial" class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <h5> WWho can access financial Aid? </h5>
