  ...
  <body>
   ...
   <!-- Admin Manage Users Page
         ...
         <div id="tf-contact" class="text-center">
             ...
             <?php
                     include_once('../config.php');
                     $q1=mysqli_query($db1, "select * from userlogindetails where usertype = 'psychiatrist' or usertype = 'lawyer' ");
             ?>
                    ...
                    <?php
                           while($row=mysqli_fetch_array($q1)) {
                   			$i=1;
                                   ...
                                   echo "<td>  <a style='color: whitesmoke;'  href='deleteuser.php?eid=" . $row['userid'] . "'><button type='button' class='btn btn-success'>Delete</button> </a></td>";
                                   echo "</tr>";
                               }
                              $i=$i+1;
                    ?>
