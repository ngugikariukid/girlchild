                  ...
                  <div class="row">
                      <div class="col-md-8 col-md-offset-2">
                          ...
                          <div class="section-title center">
                              ...
                              <small><em>Your donation will go along way in helping our course. Thanks in advance. </em></small>
                          </div>

                          <form method="POST" action="insertdonation.php">
                              <div class="row">

                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <label for="exampleInputEmail1">Your Mobile Number:</label>
                                          <input name="mobile" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter your mobile number" >
                                      </div>
                                  </div>
                              </div>
                              ...
                              <input type="text" name="amount" class="form-control" id="exampleInputEmail1" placeholder="Amount to donate">
                              </div>
                              ...
                              <button type="submit" class="btn tf-btn btn-default"> Donate </button>
                          </form>
                      </div>
                  </div>
              </div>
