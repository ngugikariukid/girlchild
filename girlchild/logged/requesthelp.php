...
$loggedemail = $_SESSION['email'];
       ...
       $query = mysqli_query($db1, " select * from userlogindetails WHERE useremail = '$loggedemail' " );// or die("Selecting user profile failed");
                  ...
                  <div class="row">
                      <div class="col-md-8 col-md-offset-2">
                          ...
                          <div class="section-title center">
                              <h2>GET <strong>Financial Help</strong></h2>
                              <div class="line">
                                  <hr>
                              </div>
                              <div class="clearfix"></div>
                              <small><em>We help girls receive financial assistance. Tell us how much you want and for what reason and we shall review it. </em></small>
                          </div>

                          <form method="POST" action="insertrequest.php">

                              <div class="form-group">
                              <label for="exampleInputEmail1">How much money do you need?</label>
                              <input type="text" name="amount" class="form-control" id="exampleInputEmail1" placeholder="Amount requested">
                              </div>

                              <div class="form-group">
                                  <label for="exampleInputEmail1">Explain why you need the money</label>
                                  <textarea name="reason" class="form-control" rows="3"></textarea>
                              </div>

                              <button type="submit" class="btn tf-btn btn-default"> Send Request </button>
                          </form>
                      </div>
                  </div>
              </div>
